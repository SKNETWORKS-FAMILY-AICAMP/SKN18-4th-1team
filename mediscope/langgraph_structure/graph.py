...
from langgraph_structure.nodes.web_search import web_search_node, check_quit
def create_graph_flow():
    ...
    graph.add_node("search_node", search_vectordb )
    ...
    # 엣지 선언 
    graph.set_entry_point("classify_node")  # 출발 노드 이름
    ...
    graph.add_edge("rewrite_question_node", "search_node")
